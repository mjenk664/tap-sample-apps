...
```json
{
  ...
  "projectName" : "tanzu-java-sample-app",
  "sourceRepositoryPrefix" : "index.docker.io/marijenk"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃  Info Will exclude [pom.xml, README.md, kubernetes/**, catalog/*.yaml]
┃ ┃ ┃ ┃ ┃ Debug .github/workflows/code-scan.yml didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug .github/workflows/codeql-analysis.yml didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug .gitignore didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/MavenWrapperDownloader.java didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.jar didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.properties didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug README.md matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug catalog/catalog-info.yaml matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/k8s/DEPLOYING.md matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/k8s/Tiltfile matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/k8s/deployment.yaml matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/k8s/service.yaml matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/tap/DEPLOYING.md matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/tap/Tiltfile matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug kubernetes/tap/workload.yaml matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug pom.xml matched [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/helloapp/HelloAppApplication.java didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
┃ ┃ ┃ ┗ ┗ Debug src/test/java/com/example/helloapp/HelloAppApplicationTests.java didn't match [pom.xml, README.md, kubernetes/**, catalog/*.yaml] -> included
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [hello-fun->tanzu-java-sample-ap...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: hello-fun->: tanzu-java-sample-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [dev.local->index.docker.io/mari...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [hello-fun template repo->tanzu-java-sample-ap...(truncated)]
